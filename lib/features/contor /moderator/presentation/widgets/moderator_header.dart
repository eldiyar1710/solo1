...
class ModeratorHeader extends ConsumerWidget {
  final String title;
  const ModeratorHeader({super.key, required this.title});
  @override
              ...
              child: Transform.scale(
                ...
                child: Stack(alignment: Alignment.center, children: [
                  ClipRRect(
                    ...
                    child: BackdropFilter(filter: ImageFilter.blur(sigmaX: 12, sigmaY: 12), child: const SizedBox(width: 520, height: 10)),
                  ),
                  Container(
                    width: MediaQuery.of(c).size.width - 48,
                ...
                child: Container(
                  ...
                  child: Material(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      const Divider(color: Color.fromARGB(33, 238, 235, 235), height: 1),
                      InkWell(
                        onTap: () {
                          entry.remove();
                          logout(ctx);
